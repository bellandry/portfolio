    ...
    <>
      ...
      >
        <div className="h-[600vh] relative" ref={ref}>
          <div className="w-screen h-[calc(100vh-5rem)] text-center flex items-center justify-center flex-col gap-48 text-6xl lg:text-8xl bg-gradient-radial from-gray-900 to-black">
