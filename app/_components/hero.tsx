    ...
    <div className="h-full flex flex-col px-4 md:px-12 lg:px-20 xl:px-56 md:gap-x-10 md:flex-row-reverse py-8 justify-between">
      ...
      <div className="h-1/2 flex flex-col items-center justify-center md:h-full md:w-3/5 lg:w-1/2 md:items-start">
        ...
        <div className="flex flex-col gap-4 lg:gap-12">
          ...
          <p className="text-sm md:text-md lg:text-xl text-center md:text-left">Hello ! Je suis Landry BELLA, développeur Full Stack Javascript et PHP basé au Cameroun, avec plus de 5 ans d&apos;expériences professionnelles.</p>
          <div className="flex gap-4 items-center justify-center md:justify-start">
            ...
            <Link href="/contact">
              <button className="p-3 md:p-4 rounded-md ring-1 ring-white hover:bg-white hover:text-black transition-all">On se parle ?</button>
            </Link>
          </div>
          <div className="flex gap-4 items-center justify-center md:justify-start">
            <SocialMedias />
