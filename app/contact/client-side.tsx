  ...
  return (
    <>
      <motion.div
        ...
        <div className="h-full w-full flex flex-col md:flex-row items-center justify-center p-4 md:px-12 md:py-10 lg:px-20 lg:py-16 xl:px-56 xl:py-40 bg-gradient-to-b from-black to-gray-950">
