      ...
      <div className="md:hidden">
        ...
        {open && (
          <motion.div
            ...
            className="absolute z-30 top-0 left-0 bottom-0 w-full h-full bg-gradient-radial from-gray-900 to-black flex flex-col text-4xl items-center justify-center">
            <motion.div
